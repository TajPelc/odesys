...
<?php }?>
    <?php if($connectToAccount) { ?>
        ...
        <p>To keep your decision model permanently please log in with a social account. Don’t worry. We don’t require any special permissions. Your data is safe with us, we won’t share it with anyone without your permission. If you decide not to log in, you are still able to finish the process, but you won't be able to make any changes to the decision model once you leave the page. Read the full <a href="#">terms of service</a> for more information.</p>
    <?php } else { ?>
