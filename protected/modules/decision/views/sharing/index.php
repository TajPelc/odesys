...
<div id="content">
    <form action="" method="post">
        <div>
            ...
            <input disabled="disabled" type="input" id="title_edit" name="title_edit" value="<?php echo $this->Decision->title; ?>"/ -->
            ...
            <dl<?php if($this->Decision->isPublished()) { ?> class="l"<?php } ?>>
            ...
            <dl class="l">
                ...
                <dd>
                    <input type="checkbox" name="facebook_share" />
                </dd>
            </dl>
            <?php } ?>
            <div class="last"></div>
