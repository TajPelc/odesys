...
Index.Rotation = function() {
    ...
    $('#content ol li:first p').switchClass('', 'glow', 1000);
...
Index.Rotate = function() {
    ...
    //Highlight list
    var currentList = $('#content ol li.current');

    //Get next list
    var nextList = ((currentList.next().length) ? ((currentList.next().hasClass('glow')) ? $('#content ol li:first') : currentList.next()) : $('#content ol li:first'));
