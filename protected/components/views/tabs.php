<div id="mainmenu">
    <?php $this->widget('zii.widgets.CMenu',array(
       'items'=>array(
            ...
            array('label' => $project->title,                       'url'=>array('/project/details'),       'visible' => Project::isProjectActive(), 'active' => $checkUrl, 'linkOptions' => array('id' => (Project::isProjectActive() && !$checkUrl ? 'display-project-warning' : 'project-disabled'))),
