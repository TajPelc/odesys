...
<div id="sidebar">
    <p><em>Drag and drop the most important criteria to the top of the list.</em></p>
    <p>Add between 2 and 10 criteria.</p>
    <p>Criteria priority exponentially decends from top to bottom.</p>
    <p>Think twice about most and least desired values.</p>
    <p>Set the best and worst values low or high enough that no alternative that you are considering falls under or over this marign.</p>
</div>